...
description: >
  Generates structured practice questions (True/False, explanatory, coding, use case)
  from lecture notes, slides, or any educational document. Use this skill whenever a
  user wants to quiz themselves or students, create exam prep materials, make study
  guides, or turn any lecture content into a question set — regardless of phrasing or
...
- If the user requests **LaTeX output**, read `assets/questions_template.tex` before generating — use it as the document skeleton.
- If the user requests **Markdown output**, read `assets/markdown_template.md` before generating — use it as the document skeleton.
